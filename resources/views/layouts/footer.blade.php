    ...
    <div class="relative max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div class="lg:col-span-3">
                <h3 class="text-xl font-bold mb-6 text-white">Restez informé</h3>
                <p class="text-blue-100 mb-4">Recevez nos dernières offres et actualités</p>
                <form class="space-y-4">
                    <div class="flex">
                        <input type="email" placeholder="Votre email" class="flex-1 px-4 py-3 bg-white/10 border border-white/20 rounded-l-lg text-white placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent">
                        <button type="submit" class="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-r-lg transition-all duration-300 hover:shadow-lg">
                            S'abonner
                        </button>
                    </div>
                </form>
